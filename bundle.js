...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	var t0_value = get_store_value(routes)[ctx.document.location.pathname] + "", t0, t1, t2, t3, switch_instance_anchor, current;
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t2 = claim_text(nodes, ctx.defaultComponent);
    		...
    		p: function update(changed, ctx) {
    			if (!current || changed.defaultComponent) {
    				set_data_dev(t2, ctx.defaultComponent);
    			}
