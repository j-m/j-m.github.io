...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      const route = get_store_value(routes)[document.location.pathname];
    ...
    async function load(){ 
      const data = await fetch(`resources/data/tagable.json`, { 
        headers : {  
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h2, file$1, 28, 2, 598);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block_1.name, type: "else", source: "(28:2) {:else}", ctx });
    	return block;
    }
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(img, file$1, 26, 2, 539);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_2.name, type: "if", source: "(26:2) {#if logo}", ctx });
    	return block;
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(img, file$1, 34, 33, 847);
    			attr_dev(a, "class", "url");
    			attr_dev(a, "href", ctx.github);
    			add_location(a, file$1, 34, 2, 816);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_1.name, type: "if", source: "(34:2) {#if github}", ctx });
    	return block;
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(p, file$1, 43, 2, 1119);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(39:2) {#if tags}", ctx });
    	return block;
    }

    // (40:2) {#each tags as tag}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(40:2) {#each tags as tag}", ctx });
    	return block;
    }
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { age, caption, date, description, github, logo, preview, title } = $$props;
      ...
      onMount(async function() {
    	...
    	const writable_props = ['age', 'caption', 'date', 'description', 'github', 'logo', 'preview', 'title'];
    	Object.keys($$props).forEach(key => {
    	...
    	$$self.$capture_state = () => {
    		return { age, caption, date, description, github, logo, preview, title, tags };
    	};
    ...
    class Project extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, ["age", "caption", "date", "description", "github", "logo", "preview", "title"]);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(p, "class", "loading");
    			add_location(p, file$2, 18, 0, 343);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$2, 12, 0, 232);
    		},
    ...
    const file$3 = "src\\routes\\Privacy.svelte";
    ...
    class Privacy extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Privacy", options, id: create_fragment$6.name });
    	}
    }

    /* src\routes\Sitemap.svelte generated by Svelte v3.12.1 */

    const file$4 = "src\\routes\\Sitemap.svelte";
    ...
    class Sitemap extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Sitemap", options, id: create_fragment$7.name });
    	}
    }
